...
import * as AccountsAPI from 'test-acme/resources/accounts/accounts';
...
export class Accounts extends APIResource {
   ...
   */
  retrieve(accountToken: string, options?: Core.RequestOptions): Core.APIPromise<AccountConfigurations> {
  ...
  ): Core.APIPromise<AccountConfigurations> {
...
export interface AccountConfigurations {
   ...
   * feature is disabled.
   */
  spend_limit: AccountConfigurations.SpendLimit;
  ...
  account_holder?: AccountConfigurations.AccountHolder;
  ...
  verification_address?: AccountConfigurations.VerificationAddress;
}
...
export namespace Accounts {
  export import AccountConfigurations = AccountsAPI.AccountConfigurations;
